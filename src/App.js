      ...
      <div className="site">
        ...
        <header className="header">
          ...
          <div className="header-box">
            ...
            <svg height="50" width="90%" className="job-titles">
          ...
          <div data-aos="fade-up" className="section-container">
            ...
            <div className="p-container">
              <p>
                ...
                experience in web development and programming, passionate to
                learn new programming technologies, offering solving problems
                using logic, motivated by effective design of highly functioning
                programs. Seeking a position where I can enhance my skills in
                web technologies to develop and implement solutions that meet
                business needs.
              </p>
        ...
        <section id="experience">
          <div data-aos="fade-down" className="section-container exp-section">
            <h1 data-aos="fade-right" data-content="Experience">
            ...
            <div className="exp-container">
              ...
              <p>
                ...
                Ministry of Communications and Information. We came out with
                four real-world projects in many programming languages such as
                JS, ReactJS, NodeJS, ExpressJS, MongoBD, Ruby, Ruby on Rails,
